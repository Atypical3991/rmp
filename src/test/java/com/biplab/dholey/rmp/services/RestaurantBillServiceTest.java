...
public class RestaurantBillServiceTest {
    ...
    @Test
    public void test_generateBill_with_emptyOrdersItemListCase() {
    ...
    @Test
    public void test_generateBill_with_emptyUnBilledOrdersItemListCase() {
        RestaurantBillControllerGenerateBillRequest request = new RestaurantBillControllerGenerateBillRequest();
        request.setTableItemId(1L);
    ...
    @Test
    public void test_generateBill_with_nullFoodMenuItemForGivenOrderCase() {
        RestaurantBillControllerGenerateBillRequest request = new RestaurantBillControllerGenerateBillRequest();
        request.setTableItemId(1L);
        request.setOrderIds(List.of(1L));
    ...
    @Test
    public void test_generateBill_with_updateBillGenerationStatusFailureCase() {
        RestaurantBillControllerGenerateBillRequest request = new RestaurantBillControllerGenerateBillRequest();
        request.setTableItemId(1L);
        request.setOrderIds(List.of(1L));
    ...
    @Test
    public void test_generateBill_with_updateBillGenerateAtFailureCase() {
        RestaurantBillControllerGenerateBillRequest request = new RestaurantBillControllerGenerateBillRequest();
        request.setTableItemId(1L);
        request.setOrderIds(List.of(1L));
    ...
    @Test
    public void test_generateBill_with_singleOrderItemSuccessCase() {
        RestaurantBillControllerGenerateBillRequest request = new RestaurantBillControllerGenerateBillRequest();
        request.setTableItemId(1L);
        request.setOrderIds(List.of(1L));
    ...
    @Test
    public void test_generateBill_with_multiOrderItemsSuccessCase() {
    ...
    @Test
    public void test_fetchAllBillsByTableId_emptyListSuccessCase() {
    ...
    @Test
    public void test_fetchAllBillsByTableId_nonEmptyListSuccessCase() {
    ...
    @Test
    public void test_fetchBillDetailsById_emptyBillItemCase() {
    ...
    @Test
    public void test_fetchBillDetailsById_foodMenuItemNotFoundCase() {
        BillItem billItem = new BillItem();
        billItem.setId(1L);
    ...
    @Test
    public void test_fetchBillDetailsById__success_paymentSuccessBillStatusWithMultiOrdersCase() {
        BillItem billItem = new BillItem();
        billItem.setId(1L);
        billItem.setStatus(BillItemStatusEnum.PAYMENT_SUCCESS);
    ...
    @Test
    public void test_fetchBillDetailsById_success_paymentInitiatedBillStatusCase() {
        BillItem billItem = new BillItem();
        billItem.setId(1L);
    ...
    @Test
    public void test_fetchBillDetailsById_success_paymentFailedBillStatusCase() {
        BillItem billItem = new BillItem();
        billItem.setId(1L);
    ...
    @Test
    public void test_fetchBillDetailsById_emptyOrderItemsListCase() {
        BillItem billItem = new BillItem();
        billItem.setId(1L);
        billItem.setStatus(BillItemStatusEnum.BILL_GENERATED);
        billItem.setOrderItemIds(List.of(1L));
